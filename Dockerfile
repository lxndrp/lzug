...
COPY --chown=10001:10001 \
    backend/__init__.py backend/admin.py backend/admin_service.py backend/application.py backend/auth.py backend/authorization.py backend/committee_admin.py \
