...
`unknown` nach Neustart oder Verdrängung ist kein Beleg für eine unterbliebene Ausführung.
Ein fehlgeschlagener Download hinterlässt kein freigegebenes Zielartefakt.
