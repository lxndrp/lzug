...
Der erste Backend-Prototyp entschied sich für Python, SQLite und SQLAlchemy 2.x. HTTP- und Fachcode arbeiten über SQLAlchemy-Modelle, Repositories und einen kleinen Store-Adapter statt über handgeschriebene fachliche SQL-Abfragen.
