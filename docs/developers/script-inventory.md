...
| `docs/publication/publication-artifact.ps1` | Dokumentation/Publikation; Publication-Workflow | Wählt anhand erfolgreicher Läufe zur exakten Revision das aktuelle Pages-Artefakt und selektiert gezielte Reproduzierbarkeitsprüfungen. `gh` liefert JSON-Daten und GitHub Actions transportiert das Artefakt; der PowerShell-Adapter bildet die verbleibende komponentenübergreifende Auswahl nahe der Publikation ab. |
