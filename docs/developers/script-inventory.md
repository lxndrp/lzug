...
| `docs/publication.py` | Dokumentation/Publikation; `task docs:publication*` und der Publication-Workflow | Montiert mit Hugo/Blowfish, OpenAPI, TypeDoc und den generierten Referenzen ausschließlich die Produktseite und technischen Referenzen für Pages. Wiki-Inhalte bleiben im GitHub Wiki; die generische Linkprüfung bleibt im Taskfile beim Standardwerkzeug. |
