...
Die frühere textliche Schemabeschreibung unter [relationales-schema.md](../../relationales-schema.md) bleibt für bestehende Links erhalten. Sie dokumentiert den ursprünglichen Entwurf und ersetzt weder `db/schema.sql` noch die Migrationen.
